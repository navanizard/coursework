...
SCRIPT:
    cut -d, -f2 201402-citibike-tripdata.csv | cut -d' ' -f1 | sort -n | uniq -c | sort -nr | head -n1
ANSWER:
    Date: 2014-02-02 (13,816 rides)

# find the day with the fewest rides
SCRIPT:
    cut -d, -f2 201402-citibike-tripdata.csv | cut -d' ' -f1 | sort -n | uniq -c | sort -n
ANSWER:
    Date: 2014-02-13 (876 rides)

# find the id of the bike with the most rides
SCRIPT:
    cut -d, -f12 201402-citibike-tripdata.csv | sort -n | uniq -c | sort -n | tail -n1
ANSWER:
    Bike ID: 20837 (130 rides)
...
SCRIPT:
    awk -F, '{ sum += $1; trips++}; END { print sum/trips }' 201402-citibike-tripdata.csv
ANSWER:
    874.516 seconds
